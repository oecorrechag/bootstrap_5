            ...
            dbc.Container(
                [
                    ...
                    dbc.Collapse(className="navbar", children=[
                        ...
                        dbc.NavItem(dbc.NavLink(html.A("Oradores", href="#speakers",
                                        className='text-light font-weight-bold'))),

                        dbc.NavItem(dbc.NavLink(html.A("Lugar y fecha", href="#place-time",
                                        className='text-light font-weight-bold'))),
        ...
        dbc.Container([
            ...
            dbc.Row(children=[
                ...
                dbc.Col(className="col-12 col-md-6 col-lg-4 mb-4", children=[
                    ...
                    dbc.Card([
                            dbc.CardImg(src="assets/speakers/lagarto.jpg", top=True),
                            dbc.CardBody([
                                html.Div(className="badges", children=[
                                    html.Span([
